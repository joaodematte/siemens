const authErrorsCodes = {
  ...
  email_not_confirmed: 'O login não é permitido para este usuário, pois o endereço de e-mail não está confirmado.',
  ...
  hook_payload_over_size_limit: 'A carga útil do Auth excede o limite máximo de tamanho.',
  hook_timeout: 'Não foi possível alcançar o hook dentro do tempo máximo alocado.',
  hook_timeout_after_retry: 'Não foi possível alcançar o hook após o número máximo de tentativas.',
  identity_already_exists: 'A identidade à qual a API se refere já está vinculada a um usuário.',
  identity_not_found:
  ...
  manual_linking_disabled: 'Chamar supabase.auth.linkUser() e APIs relacionadas não está habilitado no servidor Auth.',
  ...
  mfa_factor_name_conflict: 'Fatores MFA para um único usuário não devem ter o mesmo nome amigável.',
  mfa_factor_not_found: 'O fator MFA não existe mais.',
  mfa_ip_address_mismatch: 'O processo de registro para fatores MFA deve começar e terminar com o mesmo endereço IP.',
  mfa_verification_failed: 'O desafio MFA não pôde ser verificado -- código TOTP incorreto.',
  ...
  mfa_totp_verify_disabled: 'Login via fatores TOTP e verificação de novos fatores TOTP está desativado.',
  mfa_phone_enroll_disabled: 'O registro de fatores MFA de telefone está desativado.',
  mfa_phone_verify_disabled:
    'Login via fatores de telefone e verificação de novos fatores de telefone está desativado.',
  no_authorization: 'Esta requisição HTTP requer um cabeçalho de Autorização, que não foi fornecido.',
  not_admin:
  ...
  oauth_provider_not_supported: 'Usando um provedor OAuth que está desativado no servidor Auth.',
  otp_disabled:
    'Login com OTPs (link mágico, OTP por e-mail) está desativado. Verifique a configuração do seu servidor.',
  otp_expired: 'O código OTP para este login expirou. Peça ao usuário para fazer login novamente.',
  ...
  phone_not_confirmed: 'O login não é permitido para este usuário, pois o número de telefone não está confirmado.',
  phone_provider_disabled: 'Cadastros estão desativados para telefone e senha.',
  provider_disabled: 'O provedor OAuth está desativado para uso. Verifique a configuração do seu servidor.',
  ...
  request_timeout: 'O processamento da requisição demorou muito. Tente a requisição novamente.',
  same_password: 'Um usuário que está atualizando sua senha deve usar uma senha diferente da atualmente usada.',
  ...
  saml_idp_already_exists: '(API de Admin.) Adicionando um provedor de identidade SAML que já foi adicionado.',
  saml_idp_not_found:
  ...
  saml_provider_disabled: 'O uso de SSO Empresarial com SAML 2.0 não está habilitado no servidor Auth.',
  ...
  signup_disabled: 'Cadastros (criação de novas contas) estão desativados no servidor.',
  ...
  sms_send_failed: 'O envio de uma mensagem SMS falhou. Verifique a configuração do seu provedor de SMS.',
  sso_domain_already_exists:
    '(API de Admin.) Apenas um domínio SSO pode ser registrado por provedor de identidade SSO.',
  sso_provider_not_found: 'Provedor SSO não encontrado. Verifique os argumentos em supabase.auth.signInWithSSO().',
  too_many_enrolled_mfa_factors: 'Um usuário só pode ter um número fixo de fatores MFA registrados.',
  unexpected_audience:
  ...
  unexpected_failure: 'O serviço Auth está degradado ou há um bug presente, sem um motivo específico.',
  user_already_exists:
  ...
  user_not_found: 'O usuário ao qual a requisição da API se refere não existe mais.',
  user_sso_managed: 'Quando um usuário vem do SSO, certos campos do usuário não podem ser atualizados (como e-mail).',
